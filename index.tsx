...
import { Button, Forms, GuildStore, Modal,openModal, React, RestAPI, TextInput, UserStore } from "@webpack/common";
...
function BulkLeaveModal(props: any) {
    ...
    return (
        <Modal
            {...props}
            size="lg"
            title={<div style={S.stickyTop}>{Header}</div>}
            preview={<div style={S.stickyBottom}>{Footer}</div>}
        >
            <div style={S.modal}>
